              ...
              <div className="flex-1">
                ...
                <div className="space-y-4">
                  {/* <div className="flex flex-wrap gap-2">
                    <button className="bg-orange-600 text-white px-4 py-2 lg:px-6 lg:py-3 rounded-lg text-sm lg:text-base font-medium hover:bg-orange-700 transition-colors">
                      ASAP
                    </button>
                    <button className="bg-gray-700 text-white px-4 py-2 lg:px-6 lg:py-3 rounded-lg text-sm lg:text-base hover:bg-gray-600 transition-colors">
                      Use Previous Order
                    </button>
                  </div> */}
                  ...
                  <div className="bg-gray-900 rounded-lg p-4 lg:p-6">
                    <div className="space-y-3 text-sm lg:text-base">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-white">AED {deliveryCharge}</span>
                      </div>
