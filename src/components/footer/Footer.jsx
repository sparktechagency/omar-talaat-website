...
export default function Footer() {
  return (
    <div className="flex flex-col border-t mt-20">
      {/* Header */}
      <header className="container mx-auto py-10 px-4 rounded-md">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <nav className="hidden lg:grid grid-cols-2 gap-4 md:gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-auto">
            ...
            <div className="flex flex-col sm:flex-row lg:flex-col gap-4">
              ...
              >
                <Button
                  variant="outline"
                  className="w-full border-gray-300 justify-between h-16"
                >
          ...
          <div className="w-full lg:w-96">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <Input
                ...
                className="py-4 sm:py-6 flex-grow"
              />
              <Button className="h-12 sm:h-auto bg-red">Sign Up</Button>
            </div>
          </div>
        </div>
      </header>
