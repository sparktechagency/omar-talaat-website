...
export default function OurShop() {
  ...
  return (
    <section className="relative w-full h-[600px] bg-[#18191b] my-12">
      ...
      <div className="absolute inset-0 p-10">
        ...
        <div className="">
          ...
          <div className="flex items-center justify-center text-center text-white px-4">
            {/* Tabs */}
            <div className="space-y-10 w-1/4">
