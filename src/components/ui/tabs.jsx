...
function TabsList({
  ...
  return (
    (<TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-black text-muted-foreground inline-flex h-12 font-black  w-fit items-center justify-center rounded-lg p-[3px]",
        className
      )}
      {...props} />)
  );
